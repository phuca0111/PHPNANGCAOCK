...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Cap nhat chapter truyện</div>
                    @if ($errors->any())
...
<div class="card-body">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" value="{{$chapter ->tomtat}}" name="tomtat" id="" rows="5" style="resize: none"></textarea>
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1">Noi dung chapter</label>
    <textarea class="form-control" name="noidung" id="noidung_chapter" rows="5" style="resize: none">{{$chapter ->noidung}}</textarea>
  </div>
