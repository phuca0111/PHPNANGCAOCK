...
class ChapterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            'slug_chapter.unique' => 'Slug da co, xin dien ten khac',
            'tieude.unique' => 'Tieu de da co, xin dien tieu de khac',
            'tieude.required'=> 'Tieu de phải có kí tự',
            'tomtat.required'=> 'Tom tat phải có',
            'noidung.required'=> 'Noj dung phải có',
