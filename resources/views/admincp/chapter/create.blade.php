...
<div class="card-body">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" value="{{old('tomtat')}}" name="tomtat" id="" rows="5" style="resize: none"></textarea>
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1">Noi dung chapter</label>
    <textarea class="form-control" value="{{old('tomtat')}}" name="noidung" id="noidung_chapter" rows="5" style="resize: none"></textarea>
  </div>
